...
struct ChartTitle_Previews: PreviewProvider {
    @State static var row: DisplayPlanetRow = DisplayPlanetRow(planets: [], id: 0, type: .Planets(chartModel: ChartViewModel(chartName: "mike", chartType: .Natal)), name: "mike", calculationSettings: CalculationSettings())
